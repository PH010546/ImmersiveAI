...
description: Universal constraint governing implementation approval levels for original mod code (mandatory full diff) vs newly added code (approval required, full diff optional).
trigger: always_on
---

# Strict Implementation Guardrail: Tiered Approval & Modification Rules
...
3. **Discussion vs. Implementation Boundary**:
